...
CUDA="${CUDA:-4,5,6,7}"
PORT="${PORT:-29500}"
MODEL_PATH="${MODEL_PATH:-/home/admin/.cache/modelscope/hub/models/LLM-Research/Meta-Llama-3.1-8B}"
CL_ROOT="${CL_ROOT:-/home/admin/workspace/aop_lab/collabmask/data/cl_preprocessed_3}"
TASK_IDS="${TASK_IDS:-0 1}"
EXP_NAME="${EXP_NAME:-cl_seq_fvg_${SEED}}"
AUTO_COMPUTE_FV="${AUTO_COMPUTE_FV:-1}"
FV_DATA_ROOT="${FV_DATA_ROOT:-./home/admin/workspace/aop_lab/collabmask/data/cl_preprocessed_3}"
